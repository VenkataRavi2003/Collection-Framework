...
public class SubstractionOfTwoMatrices{
	public static void main(String[] args) {
		...
		List<List<Integer>> result = subTwoMatrixes(list1,list2);
	...
	public static List<List<Integer>> subTwoMatrixes(List<List<Integer>> list1 , List<List<Integer>> list2){
		...
		for (int i = 0 ; i < list1.size() ; ++i) {
			...
			for (int j = 0 ; j < list1.get(i).size() ; ++j ) {
				...
				int sub = list1.get(i).get(j) - list2.get(i).get(j);
