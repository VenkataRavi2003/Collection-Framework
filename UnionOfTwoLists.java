...
public class UnionOfTwoLists{
	public static void main(String[] args) {
		...
		System.out.println("\nunionListulted List 1 :: "+list1);
		System.out.println("\nunionListulted List 2 :: "+list2);

		List<Integer> unionList = findUnionOfTwoLists(list1 , list2); 

		System.out.println("\nUnion Of Two Lists :: "+unionList);
	...
	public static List<Integer> findUnionOfTwoLists(List<Integer> list1 , List<Integer> list2){
		...
		return unionList; // returning union List
	}
}